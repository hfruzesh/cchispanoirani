document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateLanguage(lang) {
    ...
    translateElements.forEach((el) => {
      ...
      setTimeout(() => {
        el.innerHTML =
          lang === "es" ? el.getAttribute("data-es") : el.getAttribute("data-fa");
        el.style.opacity = "1";
      }, 300);
    });
    // Toggle 'farsi' class on the body for Farsi-specific styling.
    if (lang === "fa") {
  ...
  langSwitchBtn.addEventListener("click", function () {
    ...
    langSwitchBtn.innerHTML =
      currentLang === "es" ? "Switch to Farsi" : "Switch to Spanish";
    updateLanguage(currentLang);
  ...
  // Clone first and last images for an infinite effect.
  ...
  // Update images NodeList and set container width.
  images = carouselImagesContainer.querySelectorAll("img");
